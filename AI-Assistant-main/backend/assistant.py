...
def generate_reply(lead_message, property_name):
    ...
    - Offer if they want to schedule a tour or have any other questions.
    - When saying the property name do not include the preceding numbers for the properties (like "5222 The Scarlet")
